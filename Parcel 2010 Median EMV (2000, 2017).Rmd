...
emv_15 <- fread("EMV 2015 Parcel Work/Final_Res_ParcelPts_2015.txt")
...
# fwrite(emv_10, "EMV 2010 Parcel Data/2010_SFD_PINs.csv")
```
...
```{r}
emv_10 <- fread("Median 2010 EMV by Tract.csv")
emv_17 <- fread("N:\\CommDev\\Research\\Research\\Suburban-Neighborhood-Change\\Project\\Data\\EMV 2010 Parcel Data/parcel_emv_2017.csv")
emv_00 <- fread("N:\\CommDev\\Research\\Research\\Suburban-Neighborhood-Change\\Project\\Data\\EMV 2010 Parcel Data/cleaned_variables2000.csv")
...
emv_17_tidy <- emv_17 %>%
  rename(EMV_2017 = Median_EMV_2017)

emv_00_10 <- left_join(emv_00_tidy, emv_10, by = c("Tract" = "GEOID10"))
emv_00_17 <- left_join(emv_00_10, emv_17_tidy, by = "Tract")
