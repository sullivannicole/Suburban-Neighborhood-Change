...
# Longitudinal Clustering for 2+ timepoints, 2000, 2010-2017, on
...
# fwrite(cluster_3_snc, "Results/Longitudinal Clustering/8-Clusters 3-Timepoints, Random Forest Imputation, non-MUSA, All Data.csv")
```
