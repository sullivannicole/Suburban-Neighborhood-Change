...
# Longitudinal Clustering for 8 timepoints, 2010-2017, on
...
```
# Correct denominator for % with bachelor's, pull out grad/prof as well
...
# Longitudinal Clustering - 25 Variables, All timepoints
...
#fwrite(cluster_snc, "Results/Longitudinal Clustering/8-Clusters, 2010-2017, 16-Vars, k-NN Imputation.csv")
#write.xlsx(cluster_snc, "Results/Longitudinal Clustering/8-Clusters, All Timepoints, 25-Variables.xlsx")
